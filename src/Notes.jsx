...
export const Notes = () => {
  return (
    <Card title="Notes" style={{ marginTop: '20px' }}>
      ...
      <p>
        If this were a production app, I would be implementing the additional functionality:
        ...
        <ul>At least one additional visualization, especially when a single year is selected in the future</ul>
        <ul>
        ...
        <ul>
          ...
          would consider using Typescript.
        </ul>
      </p>
    </Card>
  )
